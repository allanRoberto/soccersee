...
set :scm, :git
set :repository,  "git@github.com:allanRoberto/soccersee.git" 
# set :scm, :subversion
...
set :local_path, "/Users/Allan/sites/soccersee" 
...
set :local_domain, 'soccersee.art.com.br' #FIXME
