...
function sl_enqueue_scripts() {
    ...
    wp_localize_script('azexo-simple-likes-public-js', 'simpleLikes', array(
        ...
        'like' => esc_html__('Like', 'sport-ak'),
        'unlike' => esc_html__('Unlike', 'sport-ak')
    ));
}
...
function process_simple_like() {
    ...
    if (!wp_verify_nonce($nonce, 'simple-likes-nonce')) {
        exit(esc_html__('Not permitted', 'sport-ak'));
    }
...
function get_simple_likes_button($post_id, $is_comment = NULL) {
    ...
    if (already_liked($post_id, $is_comment)) {
        ...
        $title = esc_html__('Unlike', 'sport-ak');
        $icon = $icon_full;
    } else {
        $class = '';
        $title = esc_html__('Like', 'sport-ak');
        $icon = $icon_empty;
    }
...
function get_like_count($like_count) {
    $like_text = esc_html__('Like', 'sport-ak');
...
function show_user_likes($user) {
    ...
    <table class="form-table">
        <tr>
            <th><label for="user_likes"><?php _e('You Like:', 'sport-ak'); ?></label></th>
            <td>
                <?php
    ...
    <?php else : ?>
                    <p><?php _e('You do not like anything yet.', 'sport-ak'); ?></p>
    <?php
    endif;
    wp_reset_postdata();
    ?>
