...
/*
 * Plugin Name:       Additional Checkout Attributes
 * Plugin URI:        http://fmeaddons.com/wordpress/checkout-fields-attributes
...
if ( !class_exists( 'FME_Checkout_Fields_Attributes' ) ) { 
	...
	class FME_Checkout_Fields_Attributes {
		...
		public function create_module_data() {
            ...
            $result = $wpdb->get_results( $wpdb->prepare( "SELECT * FROM ".$wpdb->fmecfa_fields,ARRAY_A) );      
	        echo count($result);   
	            if(count($result)==0) {
