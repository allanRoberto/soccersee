            ...
            <div id="general" class="hide">
                ...
                <table class="form-table">
                    <tbody>
                        <!--<tr>
                            <th scope="row">
                                <?php _e('Billing Title:','fmecfa'); ?>
                                <p class="description">(<?php _e('Main heading of the billing section.', 'fmecfa'); ?>)</p>
                            </th>
                            <td>
                                <input type="text" value="<?php echo esc_attr( $this->module_settings['billing_title'] ); ?>" name="fmecfa_module[billing_title]" placeholder="<?php _e( 'Billing Title', 'fmecfa' ); ?>" class="textinput" id="fmecfa-billing-title" />
                            </td>
                        </tr>

                        <tr>
                            <th scope="row">
                                <?php _e('Shipping Title:','fmecfa'); ?>
                                <p class="description">(<?php _e('Main heading of the shipping section.', 'fmecfa'); ?>)</p>
                            </th>
                            <td>
                                <input type="text" value="<?php echo esc_attr( $this->module_settings['shipping_title'] ); ?>" name="fmecfa_module[shipping_title]" placeholder="<?php _e( 'Shipping Title', 'fmecfa' ); ?>" class="textinput" id="fmecfa-shipping-title" />
                            </td>
                        </tr>-->
