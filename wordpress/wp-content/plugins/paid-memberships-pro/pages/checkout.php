...
<form id="pmpro_form" class="pmpro_form" action="<?php if(!empty($_REQUEST['review'])) echo pmpro_url("checkout", "?level=" . $pmpro_level->id); ?>" method="post">
	...
	<table id="pmpro_pricing_fields" class="pmpro_checkout container" width="100%" cellpadding="0" cellspacing="0" border="0">
	<thead>
		<tr>
			<th>
				<span class="pmpro_thead-name"><?php _e('Membership Level', 'pmpro');?></span>
				<?php if(count($pmpro_levels) > 1) { ?><span class="pmpro_thead-msg"><a href="<?php echo pmpro_url("levels"); ?>"><?php _e('Trocar plano de assinatura', 'pmpro');?></a></span><?php } ?>
			</th>
		</tr>
	</thead>
	<tbody>
	...
	<table id="pmpro_user_fields" class="pmpro_checkout container" width="100%" cellpadding="0" cellspacing="0" border="0">
	<thead>
		<tr>
			<th>
