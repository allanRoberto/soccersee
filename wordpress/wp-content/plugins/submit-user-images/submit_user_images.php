<?php 
/*
Plugin Name: Upload de imagens dos usuários
Plugin URI: http://www.showy.com.br/
Description: Responsável por controlar as imagens dos usuários
Author: Showy
Version: 1.0
*/
...
function sui_form_shortcode(){
  ...
  if(!is_user_logged_in()){
    ...
    return '<p>Você precisa estar logado para inserir imagens.</p>';    
  }
  ...
  function sui_get_upload_image_form($sui_image_caption = '', $sui_image_category = 0){
    ...
    $out = '';
    $out .= '<form id="sui_upload_image_form" method="post" action="">';
   
    $out .= '<input type="hidden" name="action" value="load_files" />';
