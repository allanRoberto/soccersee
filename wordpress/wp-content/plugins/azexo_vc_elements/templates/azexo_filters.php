...
if ($masonry) {
    ...
    $responsive = (array) vc_param_group_parse_atts($responsive);
    ...
    print '</script>';
    print '<div class="filterable masonry" data-selector=".entry" data-responsive="filters-' . $r . '" data-gutter="' . esc_attr($gutter) . '">';
} else {
